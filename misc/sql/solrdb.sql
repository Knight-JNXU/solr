...
insert into t_item(name) values('Reebok GL 6000 ND');
insert into t_item(name) values('Reebok AZTEC RETRO');
insert into t_item(name) values('Reebok WOR WVN JACKET');
insert into t_item(name) values('Reebok EL BLUEY COLLAB SHORT');
